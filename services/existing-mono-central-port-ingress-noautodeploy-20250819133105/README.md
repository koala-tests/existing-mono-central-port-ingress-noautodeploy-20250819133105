# existing-mono-central-port-ingress-noautodeploy-20250819133105
...
```
docker build -t existing-mono-central-port-ingress-noautodeploy-20250819133105:latest .
docker run -p:5030:9999 existing-mono-central-port-ingress-noautodeploy-20250819133105:latest
```
